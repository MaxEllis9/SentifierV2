...
viator_gui::ToggleButton::ToggleButton(int buttonColour, bool useLabel, juce::String labelText, bool isPhase)
{
    setToggleable(true);
    ...
    switch(buttonColour)
        ...
        case 1 :
            setImages(false, true, true, juce::ImageCache::getFromMemory(BinaryData::button_middle_off_png, BinaryData::button_middle_off_pngSize), 1.0f, juce::Colours::transparentBlack, juce::ImageCache::getFromMemory(BinaryData::button_middle_off_png, BinaryData::button_middle_off_pngSize), 0.8f, juce::Colours::transparentBlack, juce::ImageCache::getFromMemory(BinaryData::toggleButtonOnDBlue_png, BinaryData::toggleButtonOnDBlue_pngSize), 1.0f, juce::Colours::transparentBlack);
            break;

        case 2 :
            setImages(false, true, true, juce::ImageCache::getFromMemory(BinaryData::button_middle_off_png, BinaryData::button_middle_off_pngSize), 1.0f, juce::Colours::transparentBlack, juce::ImageCache::getFromMemory(BinaryData::button_middle_off_png, BinaryData::button_middle_off_pngSize), 0.8f, juce::Colours::transparentBlack, juce::ImageCache::getFromMemory(BinaryData::toggleButtonPurple_png, BinaryData::toggleButtonPurple_pngSize), 1.0f, juce::Colours::transparentBlack);
            break;
    }
}
